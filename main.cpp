...
public:
    ...
    void Draw (){
        ...
        Rectangle dest = {offset + position.x*cellSize, offset + position.y*cellSize, (float)cellSize, (float)cellSize};
...
public:
    ...
    Game(){
        InitAudioDevice();
        eatSound = LoadSound("Graphic/bite.mp3");
        wallSound = LoadSound("Graphic/explosion.mp3");
    }
